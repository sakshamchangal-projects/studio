...
import { Bot, Languages, Percent, User } from 'lucide-react';
...
const ClassificationIcon = ({
  ...
  if (classification === 'AI_GENERATED') {
    return <Bot className="h-16 w-16 text-destructive" />;
  }
      ...
      >
        <CardContent className="p-6">
          ...
          <p className="text-muted-foreground">
            {result.classification === 'AI_GENERATED'
              ? 'This audio is likely generated by an AI.'
              : 'This audio appears to be from a human speaker.'}
          </p>
        </CardContent>
      </Card>
